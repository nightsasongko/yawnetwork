  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Departemen</h3></div>
            <div class="col-md-6" style="text-align:right; margin-top:20px;">
                <?php
                if ($boleh_tambah) {
                    ?>
                    <a href="<?php echo base_url(); ?>backend/hakakses/tambah_departemen"><span class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</span></a>
                <?php } ?>
            </div>
    	</div>  
    </section>
            ...
            <table width="100%" class="table table-condensed table-striped table-hover dasarTable" id="example" cellspacing="0" >  
                                <thead>
                                    <tr style="background-color:#79d279">
                                        ...
                                        <th width="t7%" style="border-bottom-color:#ddd; border-color:#ddd; border-top-color:#ddd;">Nama</th>
...
$(document).ready(function () {
	if ($('table').hasClass('dasarTable')) {
		$('.dasarTable').dataTable({
			...
			"pageLength": 50,
			"ajax": "<?php echo base_url(); ?>backend/hakakses/list_departemen?iDisplayStart=0&iDisplayLength=-1",
			"aoColumns": [
