           		...
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/produk/do_edit_item_produk">
								...
								<div class="form-group">
                                    ...
                                    foreach ($list_kategori as $entry)
                                    {
                                        ...
                                        echo "<option value=\"".$entry['id_kategori']."\"";
                                        if($entry['id_kategori'] == $detail['id_kategori'])
                                        {
                                          echo " selected";
                                        }
								...
								<div class="form-group">
										...
										<input type="number" class="form-control" id="harga_umum" name="harga_umum" value="<?php echo $detail['harga_umum'];?>" step="1">
								</div>

								<div class="form-group">
										<label for="harga_distributor">Harga Distributor</label>
										<input type="number" class="form-control" id="harga_distributor" name="harga_distributor" value="<?php echo $detail['harga_distributor'];?>" step="1">
								</div>


								<div class="form-group">
										<label for="deskripsi_full">Deskripsi Full</label>
										<textarea name="deskripsi_full" class="form-control" id="deskripsi_full"><?php echo $detail['deskripsi'];?></textarea>
								</div> 
								...
								<input type="hidden" name="daftarfilelogo2" id="daftarfilelogo2" value="<?php echo $texdaftarfilegambar;?>">
                                    ...
                                    <input type="hidden" name="id" id="id" value="<?php echo $detail['id_produk'];?>">
