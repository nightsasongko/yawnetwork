  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Edit Review Produk</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/produk/do_edit_review_produk">
					...
					<div class="form-group">
						...
						<?php
							...
							{
									echo "<option value=\"".$entry['id_produk']."\"";
									if($entry['id_produk'] == $detail['id_produk'])
									{
										echo " selected";
									}
					...
					<div class="form-group">
							...
							<textarea name="review" class="form-control" id="review" rows="5"><?php echo $detail['review'];?></textarea>
					</div> 

					<div class="form-group">
							<label for="nama_orang">Nama Orang</label>
							<input type="text" class="form-control" id="nama_orang" name="nama_orang" value="<?php echo $detail['nama_orang'];?>" required>
					</div>
					...
					<div class="form-group">
						<input type="hidden" name="daftarfilelogo2" id="daftarfilelogo2" value="<?php echo $detail['avatar'];?>">


						<input type="hidden" name="id" id="id" value="<?php echo $detail['id_review'];?>">
