  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Tambah Kategori Produk</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/produk/do_tambah_kategori">
									...
									<div class="form-group">
											...
											<a href="<?php echo base_url(); ?>backend/produk/kategori" class="btn btn-warning">Kembali</a>
									</div>
